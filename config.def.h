...
static const char dmenufont[]            =  "Mononoki Nerd Font:size=14:antialias=true:autohint=true";
...
static char selbordercolor[]             = "#993d3d"; // WIndow border color
static char selfloatcolor[]              = "#282a36"; // ??

static char titlenormfgcolor[]           = "#f9f9f2"; // ??
static char titlenormbgcolor[]           = "#993d3d"; // App name bg color, when there is no runned apps
...
static char titleselbgcolor[]            = "#993d3d"; // App name bg color
...
static char tagsselfgcolor[]             = "#282a35"; // Selected tag text
static char tagsselbgcolor[]             = "#993d3d"; // Selected tag bg
...
static const char *termcmd[]  = { MY_TERMINAL, "-e", "fish" };
